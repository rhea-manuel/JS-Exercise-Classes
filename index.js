...
class Car {
  ...
  drive(miles) {
    let toReduce = miles / this.milesPerGallon;

    if (toReduce > this.tank) {
...
class Student extends Lambdasian{
  ...
  listSubjects(){
    ...
    this.favSubjects.forEach((element,index, list) => {
  ...
  //Used a callback for practice.
  PRAssignment(subject){
    return this.doProject(subject,' has submitted a PR for ');
    // return `${this.name} has submitted a PR for ${subject}`
  }

  sprintChallenge(subject){
    return this.doProject(subject,' has begun sprint challenge on ');
  }

  doProject(subject, toDo){
